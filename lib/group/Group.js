...
Group.prototype.addStringInput = function (object, value, params) {
    this._parent.addStringInput(object, value, params, this);
    return this;
};
...
Group.prototype.addNumberInput = function (object, value, params) {
    this._parent.addNumberInput(object, value, params, this);
    return this;
};
...
Group.prototype.addRange = function (object, value, params) {
    this._parent.addRange(object, value, params, this);
    return this;
};
...
Group.prototype.addCheckbox = function (object, value, params) {
    this._parent.addCheckbox(object, value, params, this);
    return this;
};
...
Group.prototype.addColor = function (object, value, params) {
    this._parent.addColor(object, value, params, this);
    return this;
};
...
Group.prototype.addButton = function (label, onPress, params) {
    this._parent.addButton(object, onPress, params, this);
    return this;
};
...
Group.prototype.addSelect = function (object, value, params) {
    this._parent.addSelect(object, value, params, this);
    return this;
};
...
Group.prototype.addSlider = function (object, value, range, params) {
    this._parent.addSlider(object, value, range, params, this);
    return this;
};
...
Group.prototype.addFunctionPlotter = function (object, value, params) {
    this._parent.addFunctionPlotter(object, value, params, this);
    return this;
};
...
Group.prototype.addPad = function (object, value, params) {
    this._parent.addPad(object, value, params, this);
    return this;
};
...
Group.prototype.addValuePlotter = function (object, value, params) {
    this._parent.addValuePlotter(object, value, params, this);
    return this;
};
...
Group.prototype.addNumberOutput = function (object, value, params) {
    this._parent.addNumberOutput(object, value, params, this);
    return this;
};
...
Group.prototype.addStringOutput = function (object, value, params) {
    this._parent.addStringOutput(object, value, params, this);
    return this;
};

Group.prototype.addCanvas = function (params) {
    this._parent.addCanvas(params, this);
    return this;
};

Group.prototype.addSVG = function (params) {
    this._parent.addSVG(params, this);
    return this;
};
