...
Panel.prototype.setPositionGlobal = function (x, y) {
    this._node.setPositionGlobal(x, y);
    return this;
};

Panel.prototype.setPositionX = function (x) {
    this._node.setPositionX(x);
    return this;
};

Panel.prototype.setPositionY = function (y) {
    this._node.setPositionY(y);
    return this;
};

Panel.prototype.setPositionGlobalX = function (x) {
    this._node.setPositionGlobalX(x);
    return this;
};

Panel.prototype.setPositionGlobalY = function (y) {
    this._node.setPositionGlobalY(y);
    return this;
};
...
Panel.prototype.getLastGroup = function () {
...
Panel.prototype._addComponent = function(){
    var groups = this._groups,
        group;
    if  (arguments[arguments.length - 1] instanceof Group) {
    ...
    return group.addComponent.apply(group,arguments);
};
...
Panel.prototype.addStringInput = function (object, value, params, group) {
    return this._addComponent(StringInput,object,value,params, group);
};
...
Panel.prototype.addNumberInput = function (object, value, params, group) {
    return this._addComponent(NumberInput,object,value,params, group);
};
...
Panel.prototype.addRange = function (object, value, params, group) {
    return this._addComponent(Range,object,value,params, group);
};
...
Panel.prototype.addCheckbox = function (object, value, params, group) {
    return this._addComponent(Checkbox,object,value,params, group);
};
...
Panel.prototype.addColor = function (object, value, params, group) {
    return this._addComponent(Color,object,value, params, group);
};
...
Panel.prototype.addButton = function (label, onPress, params, group) {
    return this._addComponent(Button,label,onPress,params, group);
};
...
Panel.prototype.addSelect = function (object, value, params, group) {
    return this._addComponent(Select,object,value,params, group);
};
...
Panel.prototype.addSlider = function (object, value, range, params, group) {
    return this._addComponent(Slider,object,value,range,params, group);
};
...
Panel.prototype.addFunctionPlotter = function (object, value, params, group) {
    return this._addComponent(FunctionPlotter,object,value,params, group);
};
...
Panel.prototype.addPad = function (object, value, params, group) {
    return this._addComponent(Pad,object,value,params, group);
};
...
Panel.prototype.addValuePlotter = function (object, value, params, group) {
    return this._addComponent(ValuePlotter,object,value,params, group);
};
...
Panel.prototype.addNumberOutput = function (object, value, params, group) {
    return this._addComponent(NumberOutput,object,value,params, group);
};
...
Panel.prototype.addStringOutput = function (object, value, params, group) {
    return this._addComponent(StringOutput,object,value,params, group);
};

Panel.prototype.addCanvas = function (params, group) {
    return this._addComponent(Canvas_,params, group);
};

Panel.prototype.addSVG = function (params, group) {
    return this._addComponent(SVG_,params, group);
};
